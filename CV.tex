...
% \resumeItem{Graphical user interface for process visualization}
%   {Developed a basic GUI using Python to visualize  the underlying processes and steps involved in Touchless ID's camera-based fingerprint ID system.}
\resumeItemListEnd

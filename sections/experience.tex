...
\resumeItemNoTitle{Created SEV mitigation tooling using \textbf{Python}, \textbf{C++}, and \textbf{thrift} to quickly roll back and freeze misbehaving ML models to a previous good deployment configuration reducing mitigation time by 90\%}
\resumeItemListEnd
